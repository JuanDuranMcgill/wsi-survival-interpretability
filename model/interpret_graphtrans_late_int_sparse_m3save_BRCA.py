...
class IPGGraphFormer(nn.Module):
    def __init__(self, num_regions, in_dim=1536, d_model=384, agt_heads=6, agt_layers=2,
...
def bootstrap_rounds(dataset, num_regions, rounds=30, train_frac=0.8, batch_size=16, epochs=8, seed_offset=0):
    ...
    for r in range(1, rounds + 1):
        ...
        for ep in range(1, epochs + 1):
            model_ep = IPGGraphFormer(num_regions=num_regions)
...
def main():
    ...
    ap.add_argument("--save_root", type=str,
                    default="/home/sorkwos/links/scratch/med3pa_bootstrap_intermediate_BRCA",
...
#python interpret_graphtrans_late_int_sparse_m3save.py --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings/Perivesical adipose tissue (extravesical fat)" --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings/Invasive urothelial carcinoma (tumor)" --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings/Normal urothelium (benign mucosa)" --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings/Inflammatory infiltrates (immune cells)" --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings/Lamina propria (fibrovascular stroma)" --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings/Blood vessels (vasculature)" --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings/Muscularis propria (detrusor muscle)" --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings/Necrosis" --bootstrap_rounds 5 --epochs 5
#python interpret_graphtrans_late_int_sparse_m3save_BRCA.py --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings_BRCA/Adipose tissue (fat)" --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings_BRCA/Blood vessels (vasculature)" --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings_BRCA/Ductal carcinoma in situ (DCIS)" --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings_BRCA/Fibrous desmoplastic stroma" --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings_BRCA/Invasive breast carcinoma (tumor cells)" --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings_BRCA/Muscle tissue (smooth or skeletal muscle)" --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings_BRCA/Necrosis or hemorrhage" --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings_BRCA/Normal breast glands and lobules (TDLU)" --class_dir "/home/sorkwos/links/scratch/UNI2_classwise_embeddings_BRCA/Tumor-infiltrating lymphocytes (immune infiltrates)" --bootstrap_rounds 1 --epochs 1