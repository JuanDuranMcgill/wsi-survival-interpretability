#!/usr/bin/env python3
# blca_clinical_linear_med3pa.py
#
...
# -------------------------------------------------------
CLINICAL_CSV = "/home/sorkwos/links/scratch/clinical_features.csv"
SAVE_ROOT    = "/home/sorkwos/links/scratch/med3pa_bootstrap"
...
def main():
    ...
    ap.add_argument("--outdir", type=str, default="results/blca_clinical_linear_med3pa")
