#!/bin/bash
#SBATCH --job-name=ablation_brca_r17
#SBATCH --account=def-senger_gpu
#SBATCH --gres=gpu:a100:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=128G
#SBATCH --time=24:00:00
#SBATCH --output=/scratch/sorkwos/slurm_logs/ablation_brca_r17_20_%j.out
#SBATCH --error=/scratch/sorkwos/slurm_logs/ablation_brca_r17_20_%j.err
...
SAVE_TMP="/scratch/sorkwos/ablation_tmp_brca_r17"
OUT="$REPO/results/region_ablation_brca_partial_r17_20.json"
