#!/bin/bash
#SBATCH --job-name=ablation_brca_r07
#SBATCH --account=def-senger_gpu
#SBATCH --gres=gpu:a100:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=128G
#SBATCH --time=24:00:00
#SBATCH --output=/scratch/sorkwos/slurm_logs/ablation_brca_r07_12_%j.out
#SBATCH --error=/scratch/sorkwos/slurm_logs/ablation_brca_r07_12_%j.err
...
SAVE_TMP="/scratch/sorkwos/ablation_tmp_brca_r07"
OUT="$REPO/results/region_ablation_brca_partial_r07_12.json"
